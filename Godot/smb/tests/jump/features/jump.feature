Feature: Jump
  ...
  Scenario Outline: Vertical jump Easy
    ...
    When I want to reach the goal with model : ./tests/jump/models/backup/easy_IL_RL
  ...
  Scenario Outline: Vertical jump Hard
    ...
    And mario at <mx> , <my>
    And An environment of size 35 x 15
    When I want to reach the goal with model : ./tests/jump/models/backup/hard_RL
    Then Reach the goal without dying
...
#      | 29 | 12 | 10 | 13 | [[28,13,3]]                                       | []    |
  ...
  Scenario Outline: Vertical jump
    ...
    And mario at <mx> , <my>
    And An environment of size 35 x 15
    When I want to reach the goal with model : ./tests/jump/models/backup/IL_RL
    Then Reach the goal without dying
